...
func (_m *TxCombiner) CombineTx(tx common.AvaxTx, signatures []*types.Signature) (common.AvaxTx, *types.Error) {
	...
	var r1 *types.Error
	if rf, ok := ret.Get(0).(func(common.AvaxTx, []*types.Signature) (common.AvaxTx, *types.Error)); ok {
		return rf(tx, signatures)
	}
...
type mockConstructorTestingTNewTxCombiner interface {
	mock.TestingT
	Cleanup(func())
}
...
func NewTxCombiner(t mockConstructorTestingTNewTxCombiner) *TxCombiner {
	mock := &TxCombiner{}
	mock.Mock.Test(t)
