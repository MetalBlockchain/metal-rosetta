...
func (_m *TxParser) ParseTx(tx *common.RosettaTx, inputAddresses map[string]*types.AccountIdentifier) ([]*types.Operation, error) {
	...
	var r1 error
	if rf, ok := ret.Get(0).(func(*common.RosettaTx, map[string]*types.AccountIdentifier) ([]*types.Operation, error)); ok {
		return rf(tx, inputAddresses)
	}
...
type mockConstructorTestingTNewTxParser interface {
	mock.TestingT
	Cleanup(func())
}
...
func NewTxParser(t mockConstructorTestingTNewTxParser) *TxParser {
	mock := &TxParser{}
	mock.Mock.Test(t)
